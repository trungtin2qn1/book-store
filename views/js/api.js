module.export = {
    getAllBooks: async function (input) {
    ...
    getCustomerInfo: async function (input) {
    ...
    //"id": string
    //"info": customer
    updateCustomerInfo: async function (id, info) {
    ...
    //"customer_id": string
    //"book_id": string 
    getBookInfo: async function (customer_id, book_id) {
...
// function get(){
//     console.log(localStorage.getItem("bcd"))

// function deleteCache() {
//     localStorage.removeItem("bcd")
// }

// function set() {
//     localStorage.setItem("bcd", "123")
// }
